...
module.exports = class extends Generator {
    ...
    writing() {
        ...
        if (this.extension_options.is_cct)
        {
            ...
            this.fs.copy(
                path.join(this.options.gulp_context, 'generators', 'app', 'templates', 'cct_icon.svg')
    ...
    _writeJavascript(data) {
        ...
        {
            this.fs.copyTpl(
                path.join(this.options.gulp_context, 'generators', 'app', 'templates', 'JavaScript', 'EntryPoint.CCT.js')
            ...
            this.fs.copyTpl(
                path.join(this.options.gulp_context, 'generators', 'app', 'templates', 'JavaScript', 'View.CCT.js')
        ...
        {
            this.fs.copyTpl(
                path.join(this.options.gulp_context, 'generators', 'app', 'templates', 'JavaScript', 'EntryPoint.SCIS.js')
                ,	this.destinationPath(full_entry_point_path + '.js')
                ,	{
                    module_name: module_full_name
                    ,	module_dep_name: module_dep_name
            ...
            this.fs.copyTpl(
                path.join(this.options.gulp_context, 'generators', 'app', 'templates', 'JavaScript', 'EntryPoint.js')
                ,	this.destinationPath(full_entry_point_path + '.js')
                ,	{
                    module_name: module_full_name
                    ,	module_dep_name: module_dep_name
            ...
            this.fs.copyTpl(
                path.join(this.options.gulp_context, 'generators', 'app', 'templates', 'JavaScript', 'View.js')
                ,	this.destinationPath(javascript_path + '.View.js')
                ,	{
                    module_name: module_full_name
                    ,	tpl_name: tpl_name
    ...
    _writeSuiteScript(data) {
        ...
        this.fs.copyTpl(
            path.join(this.options.gulp_context, 'generators', 'app', 'templates', 'SuiteScript', 'EntryPoint.js')
            ,	this.destinationPath(full_entry_point_path + '.js')
            ,	{
                module_name: module_full_name
                ,	module_dep_name: module_dep_name
        ...
        this.fs.copyTpl(
            path.join(this.options.gulp_context, 'generators', 'app', 'templates', 'SuiteScript', 'ServiceController.js')
    ...
    _writeSass(data) {
        ...
        this.fs.copyTpl(
            path.join(this.options.gulp_context, 'generators', 'app', 'templates', 'Sass', '_entry-point.scss')
    ...
    _writeTemplates(data) {
        ...
        this.fs.copyTpl(
            path.join(this.options.gulp_context, 'generators', 'app', 'templates', 'Templates', 'template.tpl')
