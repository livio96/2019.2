{{#if showFacet}}
	<div class="facets-faceted-navigation-item-color-facet-group" id="{{htmlId}}" data-type="rendered-facet" data-facet-id="{{facetId}}">
		{{#if showHeading}}
			...
			{{else}}
				<a href="#" class="facets-faceted-navigation-item-color-facet-group-expander collapsed" data-toggle="collapse" data-target="#{{htmlId}} .facets-faceted-navigation-item-color-facet-group-wrapper" data-type="collapse" title="{{facetDisplayName}}">
					<i class="facets-faceted-navigation-item-color-facet-group-expander-icon"></i>
		...
		{{else}}
		<div class="facets-faceted-navigation-item-color-facet-group-wrapper {{#if isCollapsed}} collapse in {{else}} collapse{{/if}}">
		{{/if}}
