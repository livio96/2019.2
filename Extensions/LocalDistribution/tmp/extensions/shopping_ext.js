...
extensions['TelQuest.DynamicMerchandisingZone.1.0.0'] = function(){

function getExtensionAssetsPath(asset){
	return 'extensions/TelQuest/DynamicMerchandisingZone/1.0.0/' + asset;
}

define('TelQuest.DynamicMerchandisingZone.MerchandisingZoneSliders', [
    'Merchandising.View',
    'SC.Configuration',
    'Backbone',
    'underscore',
    ...
    'use strict';
    //console.log('MerchandisingZoneSliders','MerchandisingZoneSliders');
    ...
    _.extend(MerchandisingView.prototype, {
        initSlider: function initSlider() {
            ...
            _.each(sliders, function eachSliders(slider){
                _.initBxSlider(jQuery('[data-type="carousel-items"]'), sliderBaseOptions);
            });
        }
    });
});
...
define(
	'TelQuest.DynamicMerchandisingZone.DynamicMerchandisingZone'
,   [
		'TelQuest.DynamicMerchandisingZone.MerchandisingZoneSliders'
	,	'Item.Collection'
	,	'Merchandising.View'
	,	'SC.Configuration'
	,	'Backbone'
	...
	,	'Utils'
	,	'jQuery'
	,   'telquest_dynamicmerchandisingzone_dynamicmerchandisingzone.tpl'
	]
,   function (
...
{
	'use strict';
	//console.log('DynamicMerchandisingZone','DynamicMerchandisingZone');
...
extensions['TelQuest.SiteHome.1.0.0'] = function(){

function getExtensionAssetsPath(asset){
	return 'extensions/TelQuest/SiteHome/1.0.0/' + asset;
}
...
extensions['TelQuest.WebPrice.1.0.0'] = function(){

function getExtensionAssetsPath(asset){
	return 'extensions/TelQuest/WebPrice/1.0.0/' + asset;
}

// @module TelQuest.WebPrice.WebPrice
define('TelQuest.WebPrice.WebPrice.View'
,	[
	...
	)
{
	...
	// @class TelQuest.WebPrice.WebPrice.View @extends Backbone.View
	return Backbone.View.extend({

		template: telquest_webprice_webprice_tpl
	...
	,	initialize: function (options) {
			...
			*/
			this.message = '';
			// var service_url = Utils.getAbsoluteUrl(getExtensionAssetsPath('services/WebPrice.Service.ss'));
	...
	, 	childViews: {
		...
		//@method getContext @return TelQuest.WebPrice.WebPrice.View.Context
	,	getContext: function getContext()
		{
			//@class TelQuest.WebPrice.WebPrice.View.Context
			this.message = this.message || 'Hello World!!'
			return {
				message: this.message
			};
...
extensions['TelQuest.WebStockNotification.1.0.0'] = function(){

function getExtensionAssetsPath(asset){
	return 'extensions/TelQuest/WebStockNotification/1.0.0/' + asset;
}
...
try{
	extensions['TelQuest.DynamicMerchandisingZone.1.0.0']();
	SC.addExtensionModule('TelQuest.DynamicMerchandisingZone.DynamicMerchandisingZone');
}
catch(error)
{
	console.error(error);
...
try{
	extensions['TelQuest.SiteHome.1.0.0']();
	SC.addExtensionModule('TelQuest.SiteHome.SiteHome');
}
catch(error)
{
	console.error(error);
...
try{
	extensions['TelQuest.WebPrice.1.0.0']();
	SC.addExtensionModule('TelQuest.WebPrice.WebPrice');
}
catch(error)
{
	console.error(error);
...
try{
	extensions['TelQuest.WebStockNotification.1.0.0']();
	SC.addExtensionModule('TelQuest.WebStockNotification.WebStockNotification');
}
catch(error)
{
	console.error(error);
