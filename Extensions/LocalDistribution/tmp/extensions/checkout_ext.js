...
extensions['TelQuest.ExtendLoginRegister.1.0.0'] = function(){

function getExtensionAssetsPath(asset){
	return 'extensions/TelQuest/ExtendLoginRegister/1.0.0/' + asset;
}
...
try{
	extensions['TelQuest.ExtendLoginRegister.1.0.0']();
	SC.addExtensionModule('TelQuest.ExtendLoginRegister.ExtendLoginRegister');
}
catch(error)
{
	console.error(error);
