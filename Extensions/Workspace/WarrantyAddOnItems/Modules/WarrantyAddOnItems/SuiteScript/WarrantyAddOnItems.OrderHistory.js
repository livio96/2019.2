define('TelQuest.WarrantyAddOnItems.WarrantyAddOnItems.OrderHistory', [
    'Application',
    'Utils',
    'OrderHistory.Model',
    'Configuration',
    ...
    _.extend(PlacedOrder, {
        ...
        rearrangeLinesForAddonItems: function rearrangeLinesForAddonItem() {
            ...
            _.each(Configuration.get().associatedFields, function eachAssociatedField(associatedField) {
