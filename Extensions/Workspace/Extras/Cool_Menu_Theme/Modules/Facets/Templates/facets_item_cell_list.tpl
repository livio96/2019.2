<div class="facets-item-cell-list clearfix" data-item-id="{{itemId}}" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"
    ...
    <div  itemscope itemtype="https://schema.org/Product">
        ...
        <div class="facets-item-cell-list-right">
            <h2 class="facets-item-cell-list-title">
             ...
             <small class="mpn-number">{{translate 'MPN: '}} {{mpn}}</small>
            {{#if showRating}}
