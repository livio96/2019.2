define('TelQuest.SiteSession.SiteSession.ReorderItems.Model', [
    'ReorderItems.Model',
    'Configuration',
    'underscore',
    'SC.Models.Init',
    ...
    _.extend(ReorderItemsModel, {
        search: function search(orderId, queryFilters) {
            ...
            var filterSiteOption = Configuration.get().filterSite.option;
            var filterSiteIds = Configuration.get().filterSite.ids;
