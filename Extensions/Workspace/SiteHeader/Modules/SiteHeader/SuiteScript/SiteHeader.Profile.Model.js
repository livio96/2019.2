define('TelQuest.SiteHeader.SiteHeader.Profile.Model', [
    'SC.Models.Init',
    'Profile.Model',
    'Application',
    'underscore'
    ...
    ProfileModel.getSalesRep = function getSalesRep() {
        var loggedIn2 = ModelsInit.session.isLoggedIn2();
		  nlapiLogExecution('DEBUG', 'loggedIn2 URL', loggedIn2);
		  nlapiLogExecution('DEBUG', 'loggedIn URL', ModelsInit.session.isLoggedIn());
        if (loggedIn2) {
            try {
